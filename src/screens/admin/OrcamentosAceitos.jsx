...
function OrcamentosAceitos({ theme = "light", toggleTheme = () => {} }) {
  useSeo({
  ...
  return (
    <Sidebar theme={theme} toggleTheme={toggleTheme}>
      <section className={styles.page} aria-label="Orçamentos (Aceitos)">
        <header className={styles.header}>
          <div>
            <h1 className={styles.title}>Orçamentos (Aceitos)</h1>
            <p className={styles.subtitle}>Solicitações aceitas pelo cliente.</p>
          </div>
