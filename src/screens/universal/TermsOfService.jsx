    ...
    return (
        <div className={styles.pageWrapper}>
            ...
            <div className={styles.legalContent}>
                ...
                <p className={styles.lastUpdate}>Última atualização: 28 de dezembro de 2025</p>
                ...
                <section className={styles.section}>
                    ...
                    <p>
                        Os detalhes específicos de cada projeto serão definidos em contratos separados.
                    </p>
                </section>
